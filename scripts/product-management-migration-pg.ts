...
async function runMigration() {
  console.log('Running Product Management System migration (pg)...');
  ...
  try {
    ...
    await client.query(`ALTER TABLE products ADD COLUMN IF NOT EXISTS type TEXT DEFAULT 'physical'`);
    await client.query(`ALTER TABLE products ADD COLUMN IF NOT EXISTS is_gift_card BOOLEAN DEFAULT false`);
    await client.query(`ALTER TABLE products ADD COLUMN IF NOT EXISTS digital_file_url TEXT`);
    await client.query(`ALTER TABLE products ADD COLUMN IF NOT EXISTS digital_file_name TEXT`);
    await client.query(`ALTER TABLE products ADD COLUMN IF NOT EXISTS track_quantity BOOLEAN DEFAULT true`);
